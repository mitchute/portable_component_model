...
//          << "\n";
    ...
    for (double bldgload : inputs.building_load) {
        ...
        // Now run the GHE
        BH_temp_a = ghe_a.simulate(hour, hp_a.outlet_temperature, pump.flow_rate, BH_temp_b);
        BH_temp_b = ghe_a.simulate(hour, hp_b.outlet_temperature, pump.flow_rate, BH_temp_a);
